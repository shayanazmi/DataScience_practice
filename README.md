...
| [**Practical 6**](./practical_6/practical_6_readme.md) | **Electrical Load Forecasting (MLP)** | Tapered Multi-Layer Perceptron ($29 \to 64 \to 32 \to 16 \to 1$) forecasting national hourly grid demand. Grid search comparing activations (ReLU, Sigmoid, Tanh) and losses (MSE, MAE, MAPE). | TensorFlow / Keras, Scikit-Learn, Pandas, NumPy |
